...
, 							{
								"box" : 								{
									"embedstate" : [ [ "refsNumber", 0 ], [ "inpNumber", 1 ], [ "wallNumber", 0 ] ],
									"id" : "obj-28",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 2,
...
,
					"patching_rect" : [ 715.0, 526.0, 204.0, 96.0 ],
					"varname" : "bpatcher",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 854.0, 377.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 800.0, 426.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.0, 428.0, 67.0, 22.0 ],
					"text" : "/area/6/xyz"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 735.0, 314.0, 63.0, 22.0 ],
					"text" : "unpack s f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 258.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 216.0, 87.0, 22.0 ],
					"text" : "/area/6/xyz 8.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.0, 473.0, 111.0, 22.0 ],
					"text" : "packFromMessage"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 362.0, 117.0, 22.0 ],
					"text" : "/area/6/xyz 8 6 3 1 0"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-11::obj-102" : [ "live.text[14]", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/IVES-0.1.1/externals",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
